  ...
  return (
    <>
      ...
      <div className="PageHero bger1">
        <h2 className="PHSize mb-4">Create Account</h2>
        <p className="PSizeText">Join us to start shopping and enjoy exclusive benefits</p>
      </div>
        ...
        <div className="max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
            <div className="text-center mb-8">
              <h2 className="font-serif text-3xl font-bold mb-2">Sign Up</h2>
